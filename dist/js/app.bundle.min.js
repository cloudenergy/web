window.EMAPP=angular.module("EMAPP",["ngCookies","ngResource","ngSanitize","ui.router"]),$(function(){$(document.body).html("<section ui-view></section>"),angular.bootstrap(document,["EMAPP"])});
