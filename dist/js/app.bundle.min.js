...
EMAPP.config(["$controllerProvider","$compileProvider","$filterProvider","$provide","$httpProvider","$locationProvider","$stateProvider","$urlRouterProvider",function(e,r,t,n,o,a,s,i){EMAPP.register={controller:e.register,directive:r.directive,filter:t.register,provider:n.provider,constant:n.constant,value:n.value,factory:n.factory,service:n.service},a.html5Mode(!0),o.interceptors.push(["$q","$location","SweetAlert","viewMask",function(e,r,t,n){var o=function(e,o){return n.close(),90000005===e.data.code?r.url("/dashboard/auth/logout").replace():e.data.message&&t[o?"error":"success"](e.data.message),e};return{request:function(e){return n.open(),e.url&&/\/api\//i.test(e.url)&&e.method&&(delete(e.data||e.params||{})._api_action,e.url=decodeURIComponent(e.url)),e},requestError:function(r){return e.reject(r)},response:function(e){return o(e)},responseError:function(r){return e.reject(o(r,!0))}}}]),n.service("lazyLoad",["$q","$timeout","viewMask",function(e,r,t){this.cache={},this.css=function(n){var o,a,s=this.cache,i=e.defer(),c=[],u=navigator.userAgent;return"boolean"==typeof arguments[1]?(o=arguments[2],a=arguments[1]):(o=arguments[1],a=arguments[2]),angular.forEach(n instanceof Array?n:[n],function(t,n,o){n=s[t]||e.defer(),c.push(n.promise),s[t]||(o=document.createElement("link"),o.rel="stylesheet",a?s[t]=n:o.className="lazyLoad-stylesheet",/(?:Android);?[\s\/]+([\d.]+)?/i.test(u)||/(?:iPad|iPod|iPhone).*OS\s([\d_]+)/i.test(u)?!function i(e,t){if(/webkit/i.test(u))o.sheet&&(t=!0);else if(o.sheet)try{o.sheet.cssRules&&(t=!0)}catch(a){("SecurityError"===a.name||1e3===a.code)&&(t=!0)}t||e>=200?n.resolve():r(function(){i(e+1)},10)}(0):o[document.addEventListener?"onload":"onreadystatechange"]=function(e,r){(r||!o.readyState||/loaded|complete/.test(o.readyState))&&n.resolve()},o.onerror=function(){n.reject(t)},o.setAttribute("charset","utf-8"),o.href=t,(document.head||document.getElementsByTagName("head")[0]).appendChild(o))}),t.open(),e.all(c).then(function(){(o||angular.noop)(),r(i.resolve),t.close()},function(){r(i.reject),t.close(),console.error("lazyLoad-css-error:",arguments[0])}),i.promise},this.js=function(n){var o=this.cache,a=e.defer(),s=[],i=[],c=arguments[1];return angular.forEach(n instanceof Array?n:[n],function(r,t,n){t=o[r]||e.defer(),s.push(t.promise),o[r]||(o[r]=t,i.push(r))}),function u(e,r,t){(t=i[e])&&(r=document.createElement("script"),r[document.addEventListener?"onload":"onreadystatechange"]=function(n,a){(a||!r.readyState||/loaded|complete/.test(r.readyState))&&(document.body.removeChild(r),o[t].resolve(),u(e+1))},r.onerror=function(){o[t].reject(t),u(e+1)},r.setAttribute("charset","utf-8"),r.src=t,document.body.appendChild(r))}(0),t.open(),e.all(s).then(function(){(c||angular.noop)(),r(a.resolve),t.close()},function(){r(a.reject),t.close(),console.error("lazyLoad-js-error:",arguments[0])}),a.promise}}]),n.factory("loadModules",["$cacheFactory","$injector","$log",function(o,a,s){var i=o("loadedModules"),c={$compileProvider:r,$controllerProvider:e,$filterProvider:t,$provide:n},u=0;return function l(e){var r,t=[];return u++,angular.forEach(angular.isArray(e)?e:[e],function(e){function n(e){var r,t;for(r=0,t=e.length;t>r;r++){var n=e[r],o=c[n[0]];o&&o[n[1]].apply(o,n[2])}}if(!i.get(e)){i.put(e,!0);try{angular.isString(e)?(r=angular.module(e),t=t.concat(l(r.requires)).concat(r._runBlocks),u--,n(r._invokeQueue),n(r._configBlocks)):(angular.isFunction(e)||angular.isArray(e))&&t.push(e)}catch(o){throw angular.isArray(e)&&(e=e[e.length-1]),o.message&&o.stack&&-1==o.stack.indexOf(o.message)&&(o=o.message+"\n"+o.stack),s.error("Failed to instantiate module "+e+" due to:\n"+(o.stack||o.message||o))}}}),1===u&&(u--,angular.forEach(t,function(e){a.invoke(e)})),t}}]),n.factory("routerSetup",function(){return function(){angular.forEach(EMAPP.States,function(e,r){s.state(r,e)}),i.otherwise(function(e,r){r.url(EMAPP.User.token?"/dashboard":"/dashboard/auth/login").replace()})}}),n.service("$api",["$resource",function(e){var r=function(e,r){return(/(^http:\/\/)|(^https:\/\/)|(^\/)/.test(e)?e:location.protocol+"//"+location.host+"/api/"+e)+(r?"/:_api_action":"")};angular.forEach(EMAPP.api,function(t,n){if(t instanceof Array){var o=t[0],a=t[1],s=t[2],i=t[3];o&&(s=angular.forEach(angular.extend({get:{method:"GET"},list:{method:"GET"},search:{method:"GET"},set:{},create:{},update:{},remove:{},"delete":{}},s),function(e,t){e=e||{},e.url&&(e.url=r(e.url)),e.method=e.method||"POST",e.params=angular.extend(e.url?{}:{_api_action:t},e.params)}),this[n]=e(r(o,!0),a,s,i))}},this)}]),n.factory("SweetAlert",function(){return{swal:window.swal,success:function(e,r){this.swal(e,r,"success")},error:function(e,r){this.swal(e,r,"error")},warning:function(e,r){this.swal(e,r,"warning")},info:function(e,r){this.swal(e,r,"info")}}}),n.service("viewMask",["$timeout",function(e){var r=0,t=$('<div class="view-mask"><div class="progress"><div class="progress-bar progress-bar-striped active" style="width: 100%"></div></div></div>').appendTo(document.body),n=function(n,o,a){o?(r++,t.show()):(a?r=0:r--,0>=r&&t.hide()),e(n||angular.noop)};t.hide(),this.open=function(){n(arguments[0],!0)},this.close=function(){var r,t;arguments[0]instanceof Function?(r=arguments[0],t=arguments[1]):(r=null,t=arguments[0]),e(function(){n(r,!1,t)},200)}}])}]);
