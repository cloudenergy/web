...
EMAPP.api={auth:["auth",,{login:{},logout:{}}],project:["project",,{info:{}}],business:["business",,{calendar:{cache:!0},dailycost:{},monthlykgce:{},energyconstitute:{},dailysensordetail:{},monitor:{},channeldetail:{},buildingstatistic:{},energyincomerate:{},energytimeline:{},socitystatistic:{},socitydetail:{},socitytimeline:{},settlereport:{},monthlyreport:{},dailyreport:{}}],energy:["energy",,{info:{cache:!0}}],control:["control",,{send:{}}],device:["device",,{type:{cache:!0}}]};
EMAPP.config(["$animateProvider","$controllerProvider","$compileProvider","$filterProvider","$injector","$provide","$httpProvider","$locationProvider","$stateProvider","$urlRouterProvider",function(e,r,t,n,o,a,i,s,c,u){EMAPP.register={controller:r.register,directive:t.directive,filter:n.register,provider:a.provider,constant:a.constant,value:a.value,factory:a.factory,service:a.service},s.html5Mode(!0),i.interceptors.push(["$q","$location","SweetAlert","viewMask",function(e,r,t,n){var o=function(e,o){return n.close(),90000005===e.data.code?r.url("/dashboard/auth/logout").replace():e.data.message&&t[o?"error":"success"](e.data.message),e};return{request:function(e){return n.open(),e.url&&/\/api\//i.test(e.url)&&e.method&&(delete(e.data||e.params||{})._api_action,e.url=decodeURIComponent(e.url)),e},requestError:function(r){return e.reject(r)},response:function(e){return o(e)},responseError:function(r){return e.reject(o(r,!0))}}}]),a.service("lazyLoad",["$q","$timeout","viewMask",function(e,r,t){this.cache={},this.css=function(n){var o,a,i=this.cache,s=e.defer(),c=[],u=navigator.userAgent;return"boolean"==typeof arguments[1]?(o=arguments[2],a=arguments[1]):(o=arguments[1],a=arguments[2]),angular.forEach(n instanceof Array?n:[n],function(t,n,o){n=i[t]||e.defer(),c.push(n.promise),i[t]||(o=document.createElement("link"),o.rel="stylesheet",a?i[t]=n:o.className="lazyLoad-stylesheet",/(?:Android);?[\s\/]+([\d.]+)?/i.test(u)||/(?:iPad|iPod|iPhone).*OS\s([\d_]+)/i.test(u)?!function s(e,t){if(/webkit/i.test(u))o.sheet&&(t=!0);else if(o.sheet)try{o.sheet.cssRules&&(t=!0)}catch(a){("SecurityError"===a.name||1e3===a.code)&&(t=!0)}t||e>=200?n.resolve():r(function(){s(e+1)},10)}(0):o[document.addEventListener?"onload":"onreadystatechange"]=function(e,r){(r||!o.readyState||/loaded|complete/.test(o.readyState))&&n.resolve()},o.onerror=function(){n.reject(t)},o.setAttribute("charset","utf-8"),o.href=t,(document.head||document.getElementsByTagName("head")[0]).appendChild(o))}),t.open(),e.all(c).then(function(){(o||angular.noop)(),r(s.resolve),t.close()},function(){r(s.reject),t.close(),console.error("lazyLoad-css-error:",arguments[0])}),s.promise},this.js=function(n){var o=this.cache,a=e.defer(),i=[],s=[],c=arguments[1];return angular.forEach(n instanceof Array?n:[n],function(r,t){t=o[r]||e.defer(),i.push(t.promise),o[r]||(o[r]=t,s.push(r))}),function u(e,r,t){(t=s[e])&&(r=document.createElement("script"),r[document.addEventListener?"onload":"onreadystatechange"]=function(n,a){(a||!r.readyState||/loaded|complete/.test(r.readyState))&&(document.body.removeChild(r),o[t].resolve(),u(e+1))},r.onerror=function(){o[t].reject(t),u(e+1)},r.setAttribute("charset","utf-8"),r.src=t,document.body.appendChild(r))}(0),t.open(),e.all(i).then(function(){(c||angular.noop)(),r(a.resolve),t.close()},function(){r(a.reject),t.close(),console.error("lazyLoad-js-error:",arguments[0])}),a.promise}}]),a.provider("loadModules",function(){var i={},s=[],c={$animateProvider:e,$controllerProvider:r,$compileProvider:t,$filterProvider:n,$injector:o,$provide:a};this.$get=["$injector","$log",function(e,r){function t(e,r){angular.forEach(r,function(r,t){if(t=c[r[0]])if("invoke"!==r[1])t[r[1]].apply(t,r[2]);else{var n=function(n){-1===s.indexOf(e+"-"+n)&&(s.push(e+"-"+n),t[r[1]].apply(t,r[2]))};angular.isFunction(r[2][0])?n(r[2][0]):angular.isArray(r[2][0])&&angular.forEach(r[2][0],function(e){angular.isFunction(e)&&n(e)})}})}function n(e){var o,a=[];return angular.forEach(angular.isArray(e)?e:[e],function(e){if(e&&!i[e]){i[e]=!0;try{angular.isString(e)?(o=angular.module(e))&&(a=a.concat(n(o.requires)).concat(o._runBlocks),t(e,o._invokeQueue),t(e,o._configBlocks)):(angular.isFunction(e)||angular.isArray(e))&&a.push(e)}catch(s){throw angular.isArray(e)&&(e=e[e.length-1]),s.message&&s.stack&&-1==s.stack.indexOf(s.message)&&(s=s.message+"\n"+s.stack),r.error("Failed to instantiate module "+e+" due to:\n"+(s.stack||s.message||s))}}}),a}return function(r){angular.forEach(n(r),function(r){e.invoke(r)})}}]}),a.factory("routerSetup",function(){return function(){angular.forEach(EMAPP.States,function(e,r){c.state(r,e)}),u.otherwise(function(e,r){r.url(EMAPP.User.token?"/dashboard":"/dashboard/auth/login").replace()})}}),a.service("$api",["$resource",function(e){var r=function(e,r){return(/(^http:\/\/)|(^https:\/\/)|(^\/)/.test(e)?e:location.protocol+"//"+location.host+"/api/"+e)+(r?"/:_api_action":"")};angular.forEach(EMAPP.api,function(t,n){if(t instanceof Array){var o=t[0],a=t[1],i=t[2],s=t[3];o&&(this[n]=e(r(o,!0),a,angular.forEach(angular.extend({get:{method:"GET"},list:{method:"GET"},search:{method:"GET"},set:{},create:{},update:{},remove:{},"delete":{}},i),function(e,t){e=e||{},e.url&&(e.url=r(e.url)),e.method=e.method||"POST",e.params=angular.extend(e.url?{}:{_api_action:t},e.params),e.timeout=1e4}),s))}},this)}]),a.factory("SweetAlert",function(){return{swal:window.swal,success:function(e,r){this.swal(e,r,"success")},error:function(e,r){this.swal(e,r,"error")},warning:function(e,r){this.swal(e,r,"warning")},info:function(e,r){this.swal(e,r,"info")}}}),a.service("viewMask",["$timeout",function(e){var r=0,t=$('<div class="view-mask"><div class="progress"><div class="progress-bar progress-bar-striped active" style="width: 100%"></div></div></div>').appendTo(document.body),n=function(n,o,a){o?(r++,t.show()):(a?r=0:r--,0>=r&&t.hide()),e(n||angular.noop)};t.hide(),this.open=function(){n(arguments[0],!0)},this.close=function(){var r,t;arguments[0]instanceof Function?(r=arguments[0],t=arguments[1]):(r=null,t=arguments[0]),e(function(){n(r,!1,t)},200)}}])}]);
...
EMAPP.States={auth:{url:"/dashboard/auth/:action",templateUrl:"dist/html/login.min.html?rev=1d0ac12c43",controller:"EMAPP.login",controllerAs:"self",data:{title:"用户登录"},resolve:{scripts:["lazyLoad","loadModules",function(s,t){return s.js(["/dist/js/controllers/login.min.js?rev=caf4f45a9b","/vendor/angular-md5/angular-md5.min.js?rev=cf3572fb49"],function(){t("ngMd5")})}]}},dashboard:{url:"/dashboard",templateUrl:"dist/html/dashboard.min.html?rev=678f2dfe7c",controller:"EMAPP.dashboard",controllerAs:"self",resolve:{scripts:["lazyLoad",function(s){return s.js("/dist/js/controllers/dashboard.min.js?rev=ee3d68d8b3")}]}},"dashboard.main":{url:"/main",views:{"dashboard@dashboard":{templateUrl:"dist/html/project/main.min.html?rev=aab3772a06",controller:"project.main",controllerAs:"self"}},data:{title:"首页"},resolve:{scripts:["lazyLoad",function(s){return s.js(["/dist/js/controllers/project/main.min.js?rev=853b4ffe88","/dist/js/directives/datetimepicker.min.js?rev=c5e368c8e1","/dist/js/directives/highcharts.min.js?rev=d140bc386b","/dist/js/services/pies.min.js?rev=9e992384fa","/dist/js/services/lines.min.js?rev=084292a01c","/vendor/highcharts/lib/highcharts.min.js?rev=ff4550c7b9"])}]}},"dashboard.monitor":{url:"/monitor",views:{"dashboard@dashboard":{templateUrl:"dist/html/project/monitor.min.html?rev=3ab24d9c8d",controller:"project.monitor",controllerAs:"self"}},data:{title:"设备监控"},resolve:{scripts:["lazyLoad",function(s){return s.js(["/dist/js/controllers/project/monitor.min.js?rev=4198bde733","/dist/js/directives/datetimepicker.min.js?rev=c5e368c8e1","/dist/js/directives/highcharts.min.js?rev=d140bc386b","/dist/js/directives/slimscroll.min.js?rev=5de214d4bb","/dist/js/services/lines.min.js?rev=084292a01c","/vendor/highcharts/lib/highcharts.min.js?rev=ff4550c7b9"])}]}},"dashboard.control":{url:"/control",views:{"dashboard@dashboard":{templateUrl:"dist/html/project/control.min.html?rev=26403e5c7f",controller:"project.control",controllerAs:"self"}},data:{title:"设备控制"},resolve:{scripts:["lazyLoad",function(s){return s.js(["/dist/js/controllers/project/control.min.js?rev=d758e13121","/dist/js/directives/slimscroll.min.js?rev=5de214d4bb","/vendor/jshashes/hashes.min.js?rev=26d6efaea1"])}]}},"dashboard.analyze":{url:"/analyze",views:{"dashboard@dashboard":{templateUrl:"dist/html/project/analyze.min.html?rev=dc14096329"}},data:{title:"能耗分析"},resolve:{scripts:["lazyLoad",function(s){return s.js(["/dist/js/controllers/project/analyze.min.js?rev=1e4f58ca09","/dist/js/directives/slimscroll.min.js?rev=5de214d4bb","/dist/js/directives/highcharts.min.js?rev=d140bc386b","/dist/js/services/pies.min.js?rev=9e992384fa","/dist/js/services/lines.min.js?rev=084292a01c","/vendor/highcharts/lib/highcharts.min.js?rev=ff4550c7b9"])}]}},"dashboard.statistic":{url:"/statistic/:tab",views:{"dashboard@dashboard":{templateUrl:"dist/html/project/statistic.min.html?rev=71a9801890",controller:"project.statistic",controllerAs:"self"}},data:{title:"能耗统计"},resolve:{styles:["lazyLoad",function(s){return s.css("/vendor/angular-ui-grid/ui-grid.min.css?rev=00a71d1d80")}],scripts:["lazyLoad","loadModules",function(s,t){return s.js(["/vendor/angular-ui-grid/ui-grid.min.js?rev=8f81f54e70","/dist/js/controllers/project/statistic.min.js?rev=f5e64718ae","/dist/js/directives/datetimepicker.min.js?rev=c5e368c8e1"],function(){t(["ui.grid","ui.grid.autoResize","ui.grid.exporter","ui.grid.moveColumns","ui.grid.resizeColumns"])})}]}},"dashboard.financial":{url:"/financial",views:{"dashboard@dashboard":{templateUrl:"dist/html/project/financial.min.html?rev=d41d8cd98f"}}}};
EMAPP.run(["$rootScope","$cookies","$templateCache","$state","routerSetup",function(e,t,a,n,o){n.prev={},e.$on("$stateChangeStart",function(e,t,a,o,r){if(EMAPP.lazyLoadStylesheet=$("link[class=lazyLoad-stylesheet]"),EMAPP.User.token){if("dashboard"!==t.name&&"auth"!==t.name&&(n.prev.state=t.name,n.prev.params=a,!EMAPP.Project))return e.preventDefault&&e.preventDefault(),void n.go("dashboard");if(EMAPP.Project&&"dashboard"===t.name)return e.preventDefault&&e.preventDefault(),void n.go(n.prev.state||"dashboard.main",n.prev.params)}else if("auth"!==t.name)return e.preventDefault&&e.preventDefault(),void n.go("auth",{action:"login"})}),e.$on("$stateChangeSuccess",function(e,t,a,n,o){EMAPP.lazyLoadStylesheet&&EMAPP.lazyLoadStylesheet.remove(),function(e){t.data&&t.data.title&&e.push(t.data.title),EMAPP.Project&&EMAPP.Project.name&&e.push(EMAPP.Project.name),document.title=e.join(" - ")}([])}),EMAPP.templateCache=a,o(),angular.forEach(t.getAll(),function(e,t){this[t]=e},EMAPP.User={})}]);
angular.element(document).ready(function(){angular.element(document.body).html("<section ui-view></section>"),angular.bootstrap(document,["EMAPP"])});