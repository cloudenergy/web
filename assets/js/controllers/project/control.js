...
angular.module('EMAPP').controller('project.control', ["$scope", "$api", "$timeout", function($scope, $api, $timeout) {
    ...
    var self = this,
        ...
        KEY_SHOWCUSTOMER = EMAPP.User.user + '_project_control_showcustomer';
    ...
    self.list = function() {
        ...
        if (self.deviceType.selected && !self.monitorData.loading) {
            ...
            $api.business.monitor({
                ...
                // groupby: self.showCustomer && 'TREE' || 'SENSOR',
                mode: 'SENSOR',
                usesocity: self.showCustomer || undefined,
                socitynode: self.showCustomer && self.customer && self.customer.selected || undefined,
                ...
                self.monitorData = self.monitorData.concat(data.detail);
