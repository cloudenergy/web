angular.module('EMAPP').constant('APICONFIG', {
    auth: ['auth', , {
        login: {},
        logout: {}
    }],
...
}]).service('$api', ["$rootScope", "$resource", "$location", "$state", "APICONFIG", function ($rootScope, $resource, $location, $state, APICONFIG) {
